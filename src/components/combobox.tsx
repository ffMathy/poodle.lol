import { JSXNode, QwikChangeEvent, component$, useSignal, useTask$ } from "@builder.io/qwik";
import { JSX } from "@builder.io/qwik/jsx-runtime";
import { FieldStore, FieldElementProps, FieldPath, FieldValues } from "@modular-forms/qwik";
import { defer } from "lodash";

export default component$(<TValue, TFieldValues extends FieldValues, TFieldPath extends FieldPath<TFieldValues>>(props: {
    key?: string,
    placeholder?: string,
    class?: string,
    values: TValue[],
    label: string,
    onRenderText$: (value: TValue) => string,
    ...
    return <div class={`relative mt-0 ${props.class ?? ""}`}>
        <select
            ...
            onChange$={(e, element) => {
                props.onChange$(props.values[element.selectedIndex]);
                props.fieldProps.onChange$(e, element);
            }}
        >
